...
### 1.1 Purpose
ksf_FA_JobDescriptions provides FrontAccounting UI integration for jobdescriptions.
...
| Page | Access |
|------|--------|
| List | SA_JOBDESCRIPTIONS_VIEW |
| Edit | SA_JOBDESCRIPTIONS_EDIT |
| Report | SA_JOBDESCRIPTIONS_VIEW |
