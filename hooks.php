 ...
 * 
 * @package KsfFA_ksf_FA_JobDescriptions
 * @version 2.4.3
 */

define('SS_ksf_FA_JobDescriptions', 118 << 8);
...
class hooks_ksf_FA_JobDescriptions extends hooks {
    ...
    function install_tabs($app) {
        ...
        // return new ksf_FA_JobDescriptions_app();
    }
    ...
    function install_access() {
        $security_sections[SS_ksf_FA_JobDescriptions] = _("");
        $security_areas['SA_ksf_FA_JobDescriptionsVIEW'] = array(
            SS_ksf_FA_JobDescriptions | 1, 
            _("View ")
        );
        $security_areas['SA_ksf_FA_JobDescriptionsMANAGE'] = array(
            SS_ksf_FA_JobDescriptions | 2, 
            _("Manage ")
        );
