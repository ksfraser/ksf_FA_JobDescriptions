<?php
/**
 * ksf_FA_JobDescriptions Module Hooks for FrontAccounting
 */

define('SS_ksf_FA_JobDescriptions', 100 << 8);
...
class hooks_ksf_FA_JobDescriptions extends hooks {
    ...
    function install_access() {
        ...
        $security_areas['SA_ksf_FA_JobDescriptionsVIEW'] = array(SS_ksf_FA_JobDescriptions | 1, _("View "));
        $security_areas['SA_ksf_FA_JobDescriptionsMANAGE'] = array(SS_ksf_FA_JobDescriptions | 2, _("Manage "));
